...
<section className="py-10  sm:py-16 lg:py-24">
  <div className="px-4 mx-auto  max-w-7xl sm:px-6 lg:px-8">
    <div className="max-w-xl mx-auto text-center">
      <h2 className="text-4xl font-bold text-black lg:text-5xl sm:text-5xl">Pricing <span className='text-[#E88073]'> &amp;  Plans</span></h2>
    ...
    {/* lg+ */}
    <div className="hidden mt-16 bg-white rounded-lg shadow-xl px-4 py-2 lg:block">
      <table className="w-full">
        <thead>
          <tr>
            <th className="py-8 pr-4" />
            <th className="px-4 py-8 text-center">
              <span className="text-base font-medium text-[#E88073]"> Free </span>
              <p className="mt-6 text-6xl font-bold">$0</p>
              <p className="mt-2 text-base font-normal text-gray-500">Per month</p>
            </th>
            <th className="px-4 py-8 text-center">
              <span className="text-base font-medium text-[#E88073]"> Team </span>
              <p className="mt-6 text-6xl font-bold">$99</p>
              <p className="mt-2 text-base font-normal text-gray-500">Per month</p>
            </th>
            <th className="px-4 py-8 text-center bg-[#254E58] rounded-t-xl">
              <span className="px-4 py-2 text-base font-medium text-white bg-[#E88073] rounded-full"> Popular </span>
              <p className="mt-6 text-6xl font-bold text-white">$150</p>
              <p className="mt-2 text-base font-normal text-gray-200">Per month</p>
            </th>
            <th className="px-4 py-8 text-center">
              <span className="text-base font-medium text-[#E88073]"> Enterprise </span>
        ...
        <tbody>
          <tr>
            ...
            <td className="px-4 py-4 text-center text-white bg-[#254E58] border-b border-white/20">50</td>
          ...
          <tr>
            ...
            <td className="px-4 py-4 text-center text-white bg-[#254E58] border-b border-white/20">1 TB</td>
            <td className="px-4 py-4 text-center border-b border-gray-200">Unlimited</td>
          </tr>
          <tr>
            ...
            <td className="px-4 py-4 text-center text-white bg-[#254E58] border-b border-white/20">Unlimited</td>
            <td className="px-4 py-4 text-center border-b border-gray-200">Unlimited</td>
          </tr>
          <tr>
            ...
            <td className="px-4 py-4 text-center text-white bg-[#254E58] border-b border-white/20">
              <svg className="w-5 h-5 mx-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
              </svg>
            </td>
          ...
          <tr>
            ...
            <td className="px-4 py-6 text-center">
              <a href="#" title className="inline-flex items-center font-semibold text-[#E88073] hover:text-[#254E58]">
                Get Started
  ...
  <div className="block mt-12 border-t border-b border-gray-200 divide-y divide-gray-200 lg:hidden">
    <div className="grid grid-cols-4 text-center divide-x divide-gray-200">
      <div className="px-2 py-2">
        <span className="text-sm font-medium text-[#E88073]"> Free </span>
        <p className="mt-2 text-xl font-bold">$0</p>
        <span className="mt-1 text-sm font-normal text-gray-500"> Per month </span>
      </div>
      <div className="px-2 py-2">
        <span className="text-sm font-medium text-[#E88073]"> Team </span>
        <p className="mt-2 text-xl font-bold">$99</p>
        <span className="mt-1 text-sm font-normal text-gray-500"> Per month </span>
      </div>
      <div className="px-2 py-2">
        <span className="text-sm font-medium text-[#E88073]"> Popular </span>
        <p className="mt-2 text-xl font-bold">$150</p>
        <span className="mt-1 text-sm font-normal text-gray-500"> Per month </span>
      </div>
      <div className="px-2 py-2">
        <span className="text-sm font-medium text-[#E88073]"> Enterprise </span>
